export function renderPaginationButtons(config) {
    ...
    const prevClass = `nav-prev carousel-control-prev link-${config.inverseTheme} w-auto px-6`;
    const nextClass = `nav-next carousel-control-next link-${config.inverseTheme} w-auto px-6`;
