...
export function renderCTA(finalType, config, postTitle, postUrl) {
    ...
    const baseClasses = `js-cta-link inline-block text-label-lg font-bold no-underline px-4 py-2 hover:opacity-100 transition-opacity opacity-75 ${themeClasses} ${isSharp ? 'rounded-none' : 'rounded-full'}`;
