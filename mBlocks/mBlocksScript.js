            ...
            success: function (fe) {
                if (fe.feed.entry) {
                    ...
                    for (let p = 0; p < l; p++) {
                        ...
                        let hD = hN = "";
                        (fTy == "q") ? (hN = '<svg class="float-start link-primary" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-quote" viewBox="0 0 16 16"><path d="M12 12a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1h-1.388c0-.351.021-.703.062-1.054.062-.372.166-.703.31-.992.145-.29.331-.517.559-.683.227-.186.516-.279.868-.279V3c-.579 0-1.085.124-1.52.372a3.322 3.322 0 0 0-1.085.992 4.92 4.92 0 0 0-.62 1.458A7.712 7.712 0 0 0 9 7.558V11a1 1 0 0 0 1 1h2Zm-6 0a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1H4.612c0-.351.021-.703.062-1.054.062-.372.166-.703.31-.992.145-.29.331-.517.559-.683.227-.186.516-.279.868-.279V3c-.579 0-1.085.124-1.52.372a3.322 3.322 0 0 0-1.085.992 4.92 4.92 0 0 0-.62 1.458A7.712 7.712 0 0 0 3 7.558V11a1 1 0 0 0 1 1h2Z"/></svg><blockquote class="blockquote link-primary text-start mt-3">' + ti + '</blockquote>') : (isH && (hD = '<h3 class="display-5 mx-lg-5 ' + (isL ? "opacity-50" : "opacity-75") + '">' + ti + '</h3>', hN = '<h5 class="card-title fw-normal ' + ((fTy == "t" || fTy == "l" || fTy == "p") ? 'text-' + iThm : "") + '">' + ti + '</h5>'));
                        ...
                        if (isI) {
                            ...
                            (fTy == "p") && (iC = ar);
                            (isR) ? (iC += ' border border-opacity-10 border-' + iThm) : (iC += ' border-0');
                            (fTy == "q") && (iS += ' height:6rem;width:6rem;', iSF += ' height:6rem;width:6rem;', iC = ' rounded-circle mx-auto mt-3');
                            iC += ' ' + cor;
                        ...
                        let B="";
                        (cta != "") && (
                            B='<button class="btn btn-' + thm +cor+(isL ? " opacity-50" : " opacity-75")+(fTy == "s" ? " p-3 px-lg-5" : (fTy == "v"?' p-2 px-4  mx-lg-5 mt-4':((fTy == "p"||fTy == "q")?' card-footer w-100 text-end link-' + iThm:(fTy=="t"?' mt-3':' bottom-0 end-0 me-3 mb-3 d-block position-absolute w-auto')))) + ' border-0" role="button" title="' + ti + '">' + cta + '</button>');
                        ...
                        //ARTICLE START
                        b += '<article class="col card border-0 h-100 g-'+ bG+' bg-' + thm +  cor + (fTy == "q" ?' text-center"':(fTy == "s" ? (' sPost" data-title="' + ti + '" data-link="' + li + '" data-summary="' + z + '" data-vidid="' + y + '" data-img="' + iV + '" data-toggle="tooltip"') : '"')) + ' role="article">';

                        //LINK START
                        if (fTy != "s") {
                            b += '<a class="h-100 overflow-hidden shadow-sm' + (fTy == "t" ? " row g-0 " : "") + ((fTy == "l" || fTy == "c"|| fTy == "g"|| fTy == "s") ? ar : "") + '" href="' + li + '" title="' + ti + '">';
                        }
                        ...
                        if (fTy != "s") {
                            if (isH) {
                                ...
                                b += '<div class="card';
                                switch (fTy) {
                                    case "v": b += '-img-overlay p-3 px-lg-5 pb-5 text-center rounded-0 d-flex"'; break;
                                    case "g": case "c": b += '-img-overlay text-bg-' + thm + ' bg-opacity-75 rounded-0"'; break;
                                    case "t": case "p": case "q": b += '-body"'; break;
                                    case "l": b += '-img-overlay text-bg-' + thm + ' bg-opacity-75 rounded-0" style="height:10%;">Latest';
